...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    .custom-grid {
        ...
        margin: 0 auto;
        text-align: center;
        border: 1px solid darkblue; /* Table border color */
        box-shadow: 0 4px 15px darkblue; /* Add box shadow to the table */
    }

    .custom-grid td {
        background-color: transparent; /* Set table cell background color to transparent */
        border: 1px solid darkblue; /* Cell border color */
    }
    ...
    .custom-grid th {
        ...
        color: white;
        padding: 10px;
        border: 1px solid black; /* Header cell border color */
    }
...
.btn-cancel {
    background-color:#e03b00; /* Red-Orange */
    border-color: #e03b00;
    color: white;
}
.custom-button {
...
.btn-cancel:hover {
    background-color: #e03b00; /* Darker Red-Orange */
    border-color: #d63500;
}
    ...
    @media only screen and (max-width: 768px) {
        #ddlExpenseType {
            ...
            border-radius: 4px; /* Rounded corners for small screens */
            border: 1px solid #ccc; /* Lighter border for mobile */
        }
        ...
        .custom-grid {
            ...
            border: darkblue; /* Remove borders for mobile */
        ...
        .btn-primary {
            ...
            padding: 12px 0; /* Increase button height */
        }
    ...
    @media only screen and (max-width: 480px) {
        ...
        .form-label {
            font-size: 1rem; /* Reduce label font size further */
        }

        .btn-primary {
            padding: 10px 0; /* Smaller button padding for mobile */
        }
 ...
 <main id="main" class="main">
    ...
    <asp:Panel ID="pnlLocalFoodFields" runat="server" Visible="false" CssClass="panel-fields">
        <div class="col-12">
            ...
            <asp:TextBox ID="txtLocalFoodDate" runat="server" CssClass="form-control" TextMode="Date" autocomplete="off" />
        ...
        <div class="col-12">
            ...
            <asp:TextBox ID="txtLocalFoodFromTime" runat="server" CssClass="form-control" TextMode="Time" AutoPostBack="true" OnTextChanged="txtFromTime_TextChanged" autocomplete="off" />
        ...
        <div class="col-12">
            ...
            <asp:TextBox ID="txtLocalFoodToTime" runat="server" CssClass="form-control" TextMode="Time" AutoPostBack="true" OnTextChanged="txtToTime_TextChanged" autocomplete="off"/>
        ...
        <div class="col-12">
            ...
            <asp:TextBox ID="txtLocalFoodAmount" runat="server" CssClass="form-control" ReadOnly="true" autocomplete="off"/>
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadLocalMiscellaneous.ClientID %>', 'txtFileName', 'btnRemoveFile')">×</button>
    </div>
</div>
     <div class="col-12">
  ...
  <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <button type="button" id="btnRemoveBillFile"
                     style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"
           title="Remove File"
                onclick="removeFile('<%= fileUploadLocalBill.ClientID %>', 'txtBillFileName', 'btnRemoveBillFile')">×</button>
    </div>
</div>
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtServiceReportFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileServiceReport.ClientID %>', 'txtServiceReportFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveServiceReportFile"
          style="position:absolute; right:6px; top:4px; display:none;
    ...
    border:none;background:none;
       ...
       text-align:center; cursor:pointer; color:#d00;"
               title="Remove File"
            onclick="removeFile('<%= fileServiceReport.ClientID %>', 'txtServiceReportFileName', 'btnRemoveServiceReportFile')">×</button>
    </div>
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtOthersApprovalFileName" class="form-control" readonly
               placeholder="Choose file..."
        ...
        <button type="button" id="btnRemoveOthersApprovalFile"
            style="position:absolute; right:6px; top:4px; display:none;
                ...
                border:none;background:none;
                   font-size:30px; font-weight:bold; line-height:24px;
                   text-align:center; cursor:pointer; color:#d00;"   title="Remove File"
            onclick="removeFile('<%= othersfileUploadApproval.ClientID %>', 'txtOthersApprovalFileName', 'btnRemoveOthersApprovalFile')">×</button>
    </div>
 ...
 <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="txtLocalBikeFromTime" ErrorMessage="To Time is required" CssClass="text-danger" />
  ...
  <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Remove button -->
        <button type="button" id="btnRemoveCabFile"
       style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadLocalCab.ClientID %>', 'txtCabFileName', 'btnRemoveCabFile')">×</button>
    </div>
...
<div class="col-12">
  ...
  <div class="col-12">
    ...
    <asp:RequiredFieldValidator ID="rfvLocalAutoDistance" runat="server" ControlToValidate="txtLocalAutoDistance" ErrorMessage="Distance is required" CssClass="text-danger" />
                           ...
                           <div class="col-12">
    <label for="txtfileUploadLocalAuto" class="form-label">Upload Bill</label>
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtAutoFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= txtfileUploadLocalAuto.ClientID %>', 'txtAutoFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveAutoFile"
                style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= txtfileUploadLocalAuto.ClientID %>', 'txtAutoFileName', 'btnRemoveAutoFile')">×</button>
    </div>
...
<asp:Panel ID="pnlAwardExpenses" runat="server" Visible="false" CssClass="panel-fields">
    <div class="col-12">
        <label for="ddlAwardExpenseType" class="form-label">Award Type</label>
        <asp:DropDownList ID="ddlAwardExpenseType" runat="server" AutoPostBack="true" 
                          OnSelectedIndexChanged="ddlAwardExpenseType_SelectedIndexChanged" CssClass="form-control">
    ...
    <div class="col-12 mt-3">
        ...
        <asp:TextBox ID="txtAwardAmount" runat="server" CssClass="form-control" ReadOnly="true"></asp:TextBox>
    </div>

   
    <div class="col-12">
    <label for="txtAwardDate" class="form-label">Award Date</label>
    <asp:TextBox ID="txtAwardDate" runat="server" CssClass="form-control" TextMode="Date" />
    <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="txtAwardDate" ErrorMessage="Date is required" CssClass="text-danger" />
</div>
</asp:Panel>
            <asp:GridView ID="GridViewSpotAward" runat="server" Visible="false" CssClass="grid-view"></asp:GridView>
<asp:GridView ID="GridViewStarAward" runat="server" Visible="false" CssClass="grid-view"></asp:GridView>
              <!-- Tour Expenses Panel -->
...
<div class="col-12">
   ...
   <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtTourMiscFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadTourMiscellaneous.ClientID %>', 'txtTourMiscFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveTourMiscFile"
                  style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadTourMiscellaneous.ClientID %>', 'txtTourMiscFileName', 'btnRemoveTourMiscFile')">×</button>
    </div>
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtTourOthersFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadTourOthers.ClientID %>', 'txtTourOthersFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveTourOthersFile"
                  style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadTourOthers.ClientID %>', 'txtTourOthersFileName', 'btnRemoveTourOthersFile')">×</button>
    </div>
    ...
    <div class="col-12">
        ...
        <asp:TextBox ID="txtRemarksTourOthers" runat="server" CssClass="form-control" TextMode="MultiLine" />
                   ...
                   <div class="col-12">
    <label for="fileUploadServiceReport" class="form-label">Service Report</label>
    ...
    border:none;background:none;
       ...
       text-align:center; cursor:pointer; color:#d00;"
            title="Remove File"
            onclick="removeFile('<%= fileUploadServiceReport.ClientID %>', 'txtServiceReportFileName', 'btnRemoveServiceReportFile')">×</button>
    </div>
</div>
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtTourApprovalFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadTourApproval.ClientID %>', 'txtTourApprovalFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveTourApprovalFile"
           style="position:absolute; right:6px; top:4px; display:none;
   
    border:none;background:none;
       font-size:30px; font-weight:bold; line-height:24px;
       text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadTourApproval.ClientID %>', 'txtTourApprovalFileName', 'btnRemoveTourApprovalFile')">×</button>
    </div>
...
<asp:Panel ID="pnlFlightFields" runat="server" Visible="false" CssClass="panel-fields">
  ...
  <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtFlightFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadFlight.ClientID %>', 'txtFlightFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveFlightFile"
                  style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadFlight.ClientID %>', 'txtFlightFileName', 'btnRemoveFlightFile')">×</button>
    </div>
...
<asp:Panel ID="pnlBusFields" runat="server" Visible="false" CssClass="panel-fields">
 ...
 <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Remove button -->
        <button type="button" id="btnRemoveBusFile"
                  style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadBus.ClientID %>', 'txtBusFileName', 'btnRemoveBusFile')">×</button>
    </div>
...
<asp:Panel ID="pnlTrainFields" runat="server" Visible="false" CssClass="panel-fields">
  ...
  <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtTrainFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadTrain.ClientID %>', 'txtTrainFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveTrainFile"
                   style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadTrain.ClientID %>', 'txtTrainFileName', 'btnRemoveTrainFile')">×</button>
    </div>
...
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadCab.ClientID %>', 'txtCabFileName', 'btnRemoveCabFile')">×</button>
    </div>
</div>
  ...
  <div class="col-12">
      ...
      <asp:RequiredFieldValidator ID="rfvTourAutoDate" runat="server" ControlToValidate="txtTourAutoDate" CssClass="text-danger" />
  </div>
                                                                                  <div class="col-12">
    ...
    <div class="custom-file-upload position-relative">
        ...
        <!-- Fake textbox -->
        <input type="text" id="txtTourAutoFileName" class="form-control" readonly
               placeholder="Choose file..."
               onclick="triggerOrOpen('<%= fileUploadTourAuto.ClientID %>', 'txtTourAutoFileName')" />

        <!-- Remove button -->
        <button type="button" id="btnRemoveTourAutoFile"
                  style="position:absolute; right:6px; top:4px; display:none;
   
border:none;background:none;
   font-size:30px; font-weight:bold; line-height:24px;
   text-align:center; cursor:pointer; color:#d00;"    title="Remove File"
            onclick="removeFile('<%= fileUploadTourAuto.ClientID %>', 'txtTourAutoFileName', 'btnRemoveTourAutoFile')">×</button>
    </div>
...
<asp:GridView ID="GridViewConveyance" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="custom-grid">
    <Columns>
        ...
        <asp:TemplateField HeaderText="Date">
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtDate" runat="server" Text='<%# Eval("Date", "{0:yyyy-MM-dd}") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                ...
                <asp:TextBox ID="txtAmount" runat="server" Text='<%# Eval("Amount") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>

        <asp:TemplateField>
            <ItemTemplate>
<asp:Button ID="btnEditConveyance" runat="server" Text="Edit" CssClass="btn btn-secondary" 
    OnClick="btnEdit1_Click" CommandArgument="Conveyance" />
<asp:Button ID="btnDelete" runat="server" CommandName="Conveyance" Text="Delete" CssClass="btn btn-danger" 
...
<asp:GridView ID="GridViewFood" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="custom-grid">
    <Columns>
        <asp:TemplateField HeaderText="Date">
            <ItemTemplate>
                <asp:Label ID="lblFoodDate" runat="server" Text='<%# Eval("Date", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                <asp:TextBox ID="txtFoodDate" runat="server" Text='<%# Eval("Date", "{0:yyyy-MM-dd}") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:Label ID="lblFoodAmount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                <asp:TextBox ID="txtFoodAmount" runat="server" Text='<%# Eval("Amount") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
<asp:Button ID="btnEditFood" runat="server" Text="Edit" CssClass="btn btn-secondary" 
    OnClick="btnEdit_Click" CommandArgument="Food" />
                                <asp:Button ID="btnDeleteFood" runat="server"  CommandName="Food" Text="Delete" CssClass="btn btn-danger" OnClick="btnDelete_Click" CommandArgument='<%# Eval("Id") %>' />
...
<asp:GridView ID="GridViewOthers" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="custom-grid">
    <Columns>
        <asp:TemplateField HeaderText="Date">
            <ItemTemplate>
                <asp:Label ID="lblOthersDate" runat="server" Text='<%# Eval("Date", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                <asp:TextBox ID="txtOthersDate" runat="server" Text='<%# Eval("Date", "{0:yyyy-MM-dd}") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:Label ID="lblOthersAmount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                <asp:TextBox ID="txtOthersAmount" runat="server" Text='<%# Eval("Amount") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
<asp:Button ID="btnEditOthers" runat="server" Text="Edit" CssClass="btn btn-secondary" 
    OnClick="btnEdit1_Click" CommandArgument="Others" />
                <asp:Button ID="btnDeleteOthers" runat="server" CommandName="Others" Text="Delete" CssClass="btn btn-danger" OnClick="btnDelete_Click" CommandArgument='<%# Eval("Id") %>' />
...
<asp:GridView ID="GridViewMiscellaneous" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="custom-grid">
    <Columns>
        <asp:TemplateField HeaderText="Date">
            <ItemTemplate>
                <asp:Label ID="lblMiscDate" runat="server" Text='<%# Eval("Date", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                <asp:TextBox ID="txtMiscDate" runat="server" Text='<%# Eval("Date", "{0:yyyy-MM-dd}") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:Label ID="lblMiscAmount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                <asp:TextBox ID="txtMiscAmount" runat="server" Text='<%# Eval("Amount") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
<asp:Button ID="btnEditMiscellaneous" runat="server" Text="Edit" CssClass="btn btn-secondary" 
    OnClick="btnEdit1_Click" CommandArgument="Miscellaneous" />     
                <asp:Button ID="btnDeleteMiscellaneous"  runat="server" CommandName="Miscellaneous" Text="Delete" CssClass="btn btn-danger" OnClick="btnDelete_Click" CommandArgument='<%# Eval("Id") %>' />
...
<asp:GridView ID="GridViewLodging" runat="server" AutoGenerateColumns="False" DataKeyNames="Id" CssClass="custom-grid">
    <Columns>
        <asp:TemplateField HeaderText="Date">
            <ItemTemplate>
                <asp:Label ID="lblLodgingDate" runat="server" Text='<%# Eval("Date", "{0:dd-MMM-yyyy}") %>'></asp:Label>
                <asp:TextBox ID="txtLodgingDate" runat="server" Text='<%# Eval("Date", "{0:yyyy-MM-dd}") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Amount">
            <ItemTemplate>
                <asp:Label ID="lblLodgingAmount" runat="server" Text='<%# Eval("Amount") %>'></asp:Label>
                <asp:TextBox ID="txtLodgingAmount" runat="server" Text='<%# Eval("Amount") %>' Visible="false" CssClass="form-control"></asp:TextBox>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField>
            <ItemTemplate>
<asp:Button ID="btnEditLodging" runat="server" Text="Edit" CssClass="btn btn-secondary" 
    OnClick="btnEdit_Click" CommandArgument="Lodging" />
                <asp:Button ID="btnDeleteLodging" runat="server" CommandName="Lodging" Text="Delete" CssClass="btn btn-danger" OnClick="btnDelete_Click" CommandArgument='<%# Eval("Id") %>' />

                </ItemTemplate>
        </asp:TemplateField>
    </Columns>
</asp:GridView>
<asp:Label ID="lblTotalLodging" runat="server" ForeColor="Green" /><!-- GridView for Conveyance -->
...
<div class="text-center mt-2">
    ...
    <asp:Label ID="lblStatusError" runat="server" ForeColor="Green" CssClass="error-message" Visible="false"></asp:Label>
</div>
