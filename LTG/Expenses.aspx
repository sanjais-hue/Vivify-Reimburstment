                                ...
                                <div class="col">
                                    <div class="card centered-card">
                                        <div
                                            ...
                                            <h5 class="card-title"
                                                style="text-align:center; flex: 1; margin: 0; color: white;">
                                                Expenses Type</h5>
                                            <div
                                        ...
                                        <%-- ═══ Excel Import Preview Panel (inside UpdatePanel for no-refresh Save) ═══
                                            --%>
                                            <asp:UpdatePanel ID="upExcelPreview" runat="server"
                                                            ...
                                                            <asp:GridView ID="gvExcelPreview" runat="server"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:BoundField DataField="FromTime"
                                                                        HeaderText="From" ItemStyle-Width="55px" />
                                            ...
                                            <%-- ═════════════════════════════════════════════ --%>
                                                ...
                                                <section class="form-container" id="mainFormSection">
                                                    ...
                                                    <div class="col-12 mb-1">
                                                        <label for="ddlExpenseType" class="form-label">Expense
                                                            Type</label>
                                                    ...
                                                    <asp:Panel ID="pnlLocalExpenses" runat="server" Visible="false"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:DropDownList ID="ddlLocalExpenseType" runat="server"
                                                                ...
                                                                CssClass="form-control">
                                                                <asp:ListItem Text="Select Local Expense Type"
                                                                    Value="" />
                                                        ...
                                                        <asp:Panel ID="pnlLocalFoodFields" runat="server"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtLocalFoodFromTime"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtLocalFoodSONo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvLocalSONo"
                                                                    runat="server" ControlToValidate="txtLocalFoodSONo"
                                                            ...
                                                            <!-- New Ref No Field -->
                                                            <div class="col-12">
                                                                <label for="txtLocalRefNo" class="form-label">Ref
                                                                    No</label>
                                                    ...
                                                    <asp:Panel ID="pnlLocalMiscellaneousFields" runat="server"
                                                        Visible="false" CssClass="panel-fields">
                                                        <div class="col-12">
                                                            <label for="txtLocalMiscDate"
                                                                class="form-label">Date</label>
                                                            <asp:TextBox ID="txtLocalMiscDate" runat="server"
                                                                CssClass="form-control" TextMode="Date" />
                                                            <asp:RequiredFieldValidator ID="rfvLocalMiscDate"
                                                                runat="server" ControlToValidate="txtLocalMiscDate"
                                                                ErrorMessage="Date is required"
                                                                CssClass="text-danger" />
                                                        </div>
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:TextBox ID="txtLocalMiscSONo" runat="server"
                                                                CssClass="form-control" />
                                                            <asp:RequiredFieldValidator ID="rfvLocalMiscSONo"
                                                                runat="server" ControlToValidate="txtLocalMiscSONo"
                                                        ...
                                                        <!-- New Ref No Field -->
                                                        <div class="col-12">
                                                            <label for="txtLocalMiscRefNo" class="form-label">Ref
                                                                No</label>
                                                    ...
                                                    <asp:Panel ID="pnlLocalOthersFields" runat="server" Visible="false"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="custom-file-upload position-relative">
                                                                ...
                                                                <input type="text" id="txtBillFileName"
    ...
    border:none;background:none;
       ...
       text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="custom-file-upload position-relative">
                                                                <!-- Hidden ASP.NET FileUpload -->
                                                                <asp:FileUpload ID="othersfileUploadApproval"
                                                                    runat="server" style="display:none;"
                                                    ...
                                                    <asp:Panel ID="pnlLocalConvenience" runat="server" Visible="false"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:DropDownList ID="ddlLocalMode" runat="server"
                                                                ...
                                                                CssClass="form-control">
                                                                <asp:ListItem Text="Select Mode of Transport"
                                                                    Value="" />
                                                        ...
                                                        <asp:Panel ID="pnlBikeFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtLocalBikeFromTime"
                                                                    class="form-label">From
                                                                    Time</label>
                                                            ...
                                                            <!-- New SMO No Field -->
                                                            <div class="col-12">
                                                                <label for="txtLocalBikeSMONo"
                                                                    class="form-label">SMO/WBS
                                                                    No</label>
                                                        ...
                                                        <asp:Panel ID="pnlCabFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="fileUploadLocalCab"
                                                                    class="form-label">Upload
                                                                    Bill</label>

                                                                <div class="custom-file-upload position-relative">
                                                                    <!-- Hidden ASP.NET FileUpload -->
                                                                    <asp:FileUpload ID="fileUploadLocalCab"
                                                                        runat="server" style="display:none;"
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtLocalCabFromTime" class="form-label">
                                                                    From
                                                                    Time</label>
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtLocalAutoFromTime" class="form-label">
                                                                    From
                                                                    Time</label>
                                                    ...
                                                    <asp:Panel ID="pnlAwardExpenses" runat="server" Visible="false"
                                                        ...
                                                        <div class="col-12">
                                                            <label for="txtAwardDate" class="form-label">Award
                                                                Date</label>
                                                    ...
                                                    <asp:Panel ID="pnlTourExpenses" runat="server" Visible="false"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:DropDownList ID="ddlTourExpenseType" runat="server"
                                                                ...
                                                                CssClass="form-control">
                                                                <asp:ListItem Text="Select Tour Expense Type"
                                                                    Value="" />
                                                                <asp:ListItem Text="Conveyance" Value="Conveyance" />
                                                                <asp:ListItem Text="Food" Value="Food" />
                                                        ...
                                                        <asp:Panel ID="pnlTourFoodFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:DropDownList ID="txtTourFoodDesignation"
                                                                    runat="server" CssClass="form-control"
                                                                    AutoPostBack="true"
                                                                    OnSelectedIndexChanged="ddlTourFoodDesignation_SelectedIndexChanged">
                                                                    <asp:ListItem Value="">Select Designation
                                                                    </asp:ListItem>
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtTourFoodToTime" class="form-label">To
                                                                    Time
                                                                </label>
                                                    ...
                                                    <asp:Panel ID="pnlTourMiscellaneousFields" runat="server"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:TextBox ID="txtTourMiscDate" runat="server"
                                                                CssClass="form-control" TextMode="Date" />
                                                            <asp:RequiredFieldValidator ID="rfvTourMiscDate"
                                                                runat="server" ControlToValidate="txtTourMiscDate"
                                                                ErrorMessage="Date is required"
                                                                CssClass="text-danger" />
                                                        </div>
                                                        <div class="col-12">
                                                            ...
                                                            <asp:TextBox ID="txtTourMiscItem" runat="server"
                                                                CssClass="form-control" />
                                                            <asp:RequiredFieldValidator ID="rfvTourMiscItem"
                                                                runat="server" ControlToValidate="txtTourMiscItem"
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:TextBox ID="txtTourMiscSmoNo" runat="server"
                                                                CssClass="form-control" />
                                                            <asp:RequiredFieldValidator ID="rfvTourMiscSmoNo"
                                                                runat="server" ControlToValidate="txtTourMiscSmoNo"
                                                                ErrorMessage="SMO No is required"
                                                                CssClass="text-danger" />
                                                        </div>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <asp:TextBox ID="txtTourMiscSoNo" runat="server"
                                                                CssClass="form-control" />
                                                            <asp:RequiredFieldValidator ID="rfvTourMiscSoNo"
                                                                runat="server" ControlToValidate="txtTourMiscSoNo"
                                                                ErrorMessage="SO No is required"
                                                                CssClass="text-danger" />
                                                        </div>

                                                        <div class="col-12">
                                                            <label for="txtTourMiscRefNo" class="form-label">Ref
                                                                No</label>
                                                            <asp:TextBox ID="txtTourMiscRefNo" runat="server"
                                                                CssClass="form-control" />
                                                            <asp:RequiredFieldValidator ID="rfvTourMiscRefNo"
                                                                runat="server" ControlToValidate="txtTourMiscRefNo"
                                                                ErrorMessage="Ref No is required"
                                                                CssClass="text-danger" />
                                                        </div>
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                        ...
                                                        <div class="col-12">
                                                            <label for="fileUploadServiceReport"
                                                                class="form-label">Service
                                                                Report</label>

                                                            <div class="custom-file-upload position-relative">
                                                                <!-- Hidden ASP.NET FileUpload -->
                                                                <asp:FileUpload ID="fileUploadServiceReport"
                                                                    runat="server" style="display:none;"
                                                                    onchange="handleFileSelect(this, 'txtServiceReportFileName', 'btnRemoveServiceReportFile')"
                                                                    accept="image/*,application/pdf" />
    ...
    border:none;background:none;
       ...
       text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                        ...
                                                        <div class="col-12">
                                                            <label for="fileUploadTourApproval"
                                                                class="form-label">Approval
                                                                Mail</label>

                                                            <div class="custom-file-upload position-relative">
                                                                <!-- Hidden ASP.NET FileUpload -->
                                                                <asp:FileUpload ID="fileUploadTourApproval"
                                                                    runat="server" style="display:none;"
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtFlightFromTime" runat="server"
                                                                    CssClass="form-control" TextMode="Time" />
                                                                <asp:RequiredFieldValidator ID="rfvFromTime"
                                                                    runat="server" ControlToValidate="txtFlightFromTime"
                                                                    ErrorMessage="From Time is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtFlightToTime" runat="server"
                                                                    CssClass="form-control" TextMode="Time" />
                                                                <asp:RequiredFieldValidator ID="rfvToTime"
                                                                    runat="server" ControlToValidate="txtFlightToTime"
                                                                    ErrorMessage="To Time is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:RequiredFieldValidator ID="rfvRemarks"
                                                                    runat="server" ControlToValidate="txtFlightRemarks"
                                                                    ErrorMessage="Remarks are required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                        ...
                                                        <asp:Panel ID="pnlBusFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtBusDate" runat="server"
                                                                    CssClass="form-control" TextMode="Date" />
                                                                <asp:RequiredFieldValidator ID="rfvBusDate"
                                                                    runat="server" ControlToValidate="txtBusDate"
                                                                    ErrorMessage="Date is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                                <label for="txtBusAmount"
                                                                    class="form-label">Amount</label>
                                                                <asp:TextBox ID="txtBusAmount" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvBusAmount"
                                                                    runat="server" ControlToValidate="txtBusAmount"
                                                                    ErrorMessage="Amount is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtToTimeBus" class="form-label">To
                                                                    Time</label>
                                                                <asp:TextBox ID="txtToTimeBus" runat="server"
                                                                    CssClass="form-control" TextMode="Time" />
                                                                <asp:RequiredFieldValidator ID="rfvToTimeBus"
                                                                    runat="server" ControlToValidate="txtToTimeBus"
                                                                    ErrorMessage="To Time is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtBusSmoNo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvBusSmoNo"
                                                                    runat="server" ControlToValidate="txtBusSmoNo"
                                                                    ErrorMessage="SMO No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtBusSoNo" class="form-label">SO/SAP
                                                                    No</label>
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtBusRefNo" class="form-label">Ref
                                                                    No</label>
                                                                <asp:TextBox ID="txtBusRefNo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvBusRefNo"
                                                                    runat="server" ControlToValidate="txtBusRefNo"
                                                                    ErrorMessage="Ref No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                        </asp:Panel>
                                                        ...
                                                        <asp:Panel ID="pnlTrainFields" runat="server" Visible="false"
                                                            CssClass="panel-fields">
                                                            <div class="col-12">
                                                                <label for="txtTrainDate"
                                                                    class="form-label">Date</label>
                                                                <asp:TextBox ID="txtTrainDate" runat="server"
                                                                    CssClass="form-control" TextMode="Date" />
                                                                <asp:RequiredFieldValidator ID="rfvTrainDate"
                                                                    runat="server" ControlToValidate="txtTrainDate"
                                                                    ErrorMessage="Date is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:RequiredFieldValidator
                                                                    ...
                                                                    ControlToValidate="txtTrainSoNo"
                                                                    ErrorMessage="SMO No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                                <label for="txtTrainRefNo" class="form-label">Ref
                                                                    No</label>
                                                        ...
                                                        <asp:Panel ID="pnlcabTourFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtCabDate" runat="server"
                                                                    CssClass="form-control" TextMode="Date" />
                                                                <asp:RequiredFieldValidator ID="rfvCabDate"
                                                                    runat="server" ControlToValidate="txtCabDate"
                                                                    ErrorMessage="Date is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                                <label for="txtCabAmount"
                                                                    class="form-label">Amount</label>
                                                                <asp:TextBox ID="txtCabAmount" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvCabAmount"
                                                                    runat="server" ControlToValidate="txtCabAmount"
                                                                    ErrorMessage="Amount is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtToTimeCab" class="form-label">To
                                                                    Time</label>
                                                                <asp:TextBox ID="txtToTimeCab" runat="server"
                                                                    CssClass="form-control" TextMode="Time" />
                                                                <asp:RequiredFieldValidator ID="rfvToTimeCab"
                                                                    runat="server" ControlToValidate="txtToTimeCab"
                                                                    ErrorMessage="To Time is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <asp:TextBox ID="txtCabSmoNo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvCabSmoNo"
                                                                    runat="server" ControlToValidate="txtCabSmoNo"
                                                                    ErrorMessage="SMO No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtCabSoNo" class="form-label">SO/SAP
                                                                    No</label>
                                                                <asp:TextBox ID="txtCabSoNo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator
                                                                    ID="RequiredFieldValidator16" runat="server"
                                                                    ControlToValidate="txtCabSoNo"
                                                                    ErrorMessage="SMO No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                            <div class="col-12">
                                                                <label for="txtCabRefNo" class="form-label">Ref
                                                                    No</label>
                                                                <asp:TextBox ID="txtCabRefNo" runat="server"
                                                                    CssClass="form-control" />
                                                                <asp:RequiredFieldValidator ID="rfvCabRefNo"
                                                                    runat="server" ControlToValidate="txtCabRefNo"
                                                                    ErrorMessage="Ref No is required"
                                                                    CssClass="text-danger" />
                                                            </div>
                                                        </asp:Panel>
                                                        ...
                                                        <asp:Panel ID="pnlAutoTourFields" runat="server" Visible="false"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="fileUploadTourAuto"
                                                                    class="form-label">Upload
                                                                    Bill</label>

                                                                <div class="custom-file-upload position-relative">
                                                                    <!-- Hidden ASP.NET FileUpload -->
                                                                    <asp:FileUpload ID="fileUploadTourAuto"
                                                                        runat="server" style="display:none;"
...
border:none;background:none;
   ...
   text-align:center; cursor:pointer; color:#d00;" title="Remove File"
                                                            ...
                                                            <div class="col-12">
                                                                <label for="txtTourAutoFromTime" class="form-label">
                                                                    From
                                                                    Time</label>
                                                    ...
                                                    <asp:Panel ID="pnlConveyanceSection" runat="server" Visible="false">
                                                        ...
                                                        <asp:GridView ID="GridViewConveyance" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="btnEditConveyance"
                                                    ...
                                                    <asp:Panel ID="pnlOthersSection" runat="server" Visible="false">
                                                        ...
                                                        <asp:Label ID="lblTotalOthers" runat="server"
                                                            ForeColor="Green" />
                                                    </asp:Panel>
                                                    <asp:Panel ID="pnlMiscellaneousSection" runat="server"
                                                        Visible="false">
                                                        ...
                                                        <asp:GridView ID="GridViewMiscellaneous" runat="server"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField>
                                                                    <ItemTemplate>
                                                                        <asp:Button ID="btnEditMiscellaneous"
                                                                            runat="server" Text="Edit"
                                                                            CssClass="btn btn-secondary"
                                                                            OnClick="btnEdit1_Click"
                                                    ...
                                                    <asp:Panel ID="pnlLodgingSection" runat="server" Visible="false">
                                                                ...
                                                                <asp:TemplateField HeaderText="Amount">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblLodgingAmount" runat="server"
                                                                            Text='<%# Eval("Amount") %>'></asp:Label>
                                                                        <asp:TextBox ID="txtLodgingAmount"
                                                        ...
                                                        <asp:Label ID="lblTotalLodging" runat="server"
                                                            ForeColor="Green" />
                                                    </asp:Panel>
                                                    ...
                                                    <div class="col-12">
                                                        ...
                                                        <div
                                                            ...
                                                            <asp:Label ID="lblTotalReimbursement" runat="server"
                                                                ...
                                                                ForeColor="DarkBlue" Font-Size="Large"
                                                                CssClass="me-auto">
                                                            </asp:Label>
                                                            ...
                                                            <div class="col-12"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <asp:GridView ID="gvCategoryDetail" runat="server"
                                                                        ...
                                                                        <HeaderStyle BackColor="#1a2a5e"
                                                                            ForeColor="white" Font-Bold="true"
                                                                            Font-Size="13px" HorizontalAlign="Center"
