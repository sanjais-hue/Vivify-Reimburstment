                    ...
                    using (Stream stream = fileUploadExcel.PostedFile.InputStream)
                    {
                        ...
                        using (OfficeOpenXml.ExcelPackage package = new OfficeOpenXml.ExcelPackage(stream))
                        {
                            ...
                            try
                            {
                                ...
                                gvImportedData.DataSource = dtDisplayData;
        ...
        protected void btnEditRow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dt != null && rowIndex < dt.Rows.Count)
                {
                    ...
                    // Hide all panels initially (similar to ddlExpenseType_SelectedIndexChanged)
                    pnlLocalExpenses.Visible = false; pnlTourExpenses.Visible = false; pnlAwardExpenses.Visible = false;
                    pnlLocalFoodFields.Visible = false; pnlLocalMiscellaneousFields.Visible = false;
                    pnlLocalOthersFields.Visible = false; pnlLocalConvenience.Visible = false;
                    pnlTourFoodFields.Visible = false; pnlTourMiscellaneousFields.Visible = false;
                    pnlTourOthersFields.Visible = false; pnlTourConvenience.Visible = false;
                    ...
                    // 2. Populate specific sub-category fields
                    if (mainCategory == "Local")
                    {
                        ...
                        switch (subCategory)
                        {
                            case "Food":
                                pnlLocalFoodFields.Visible = true;
                                txtLocalFoodDate.Text = finalDate;
                            ...
                            case "Miscellaneous":
                                pnlLocalMiscellaneousFields.Visible = true;
                                txtLocalMiscDate.Text = finalDate;
                                txtLocalMiscAmount.Text = amount;
                                txtLocalMiscItem.Text = particulars;
                                txtLocalMiscParticulars.Text = (particulars.Length > 0 && txtLocalMiscItem.Text == particulars) ? "" : particulars;
                                txtLocalMiscRemarks.Text = remarks;
                            ...
                            case "Others":
                                pnlLocalOthersFields.Visible = true;
                                txtLocalOthersDate.Text = finalDate;
                            ...
                            case "Conveyance":
                                ...
                                {
                                    try { ddlLocalMode.SelectedValue = transportMode; } catch { }
                                    ddlLocalMode_SelectedIndexChanged(null, null);

                                    switch (ddlLocalMode.SelectedValue)
                                    {
                                        case "Bike":
                                            txtLocalBikeDate.Text = finalDate;
                                            ...
                                            break;
                                        case "Cab/Bus":
                                            txtLocalCabDate.Text = finalDate;
                                            ...
                                            break;
                                        case "Auto":
                                            txtLocalAutoDate.Text = finalDate;
                                ...
                                break;
                            default:
                                // For dynamic headers that don't match, go to Miscellaneous
                                ddlLocalExpenseType.SelectedValue = "Miscellaneous";
                                pnlLocalMiscellaneousFields.Visible = true;
                                txtLocalMiscDate.Text = finalDate;
                                txtLocalMiscAmount.Text = amount;
                                txtLocalMiscItem.Text = subCategory; // Put the category name in Item
                                txtLocalMiscParticulars.Text = particulars;
                                txtLocalMiscRemarks.Text = remarks;
                                txtLocalMiscSMONo.Text = smoNo;
                                txtLocalMiscSONo.Text = soNo;
                    ...
                    else if (mainCategory == "Tour")
                    {
                        ...
                        switch (subCategory)
                        {
                            case "Food":
                                pnlTourFoodFields.Visible = true;
                                txtTourFoodDate.Text = finalDate;
                            ...
                            case "Miscellaneous":
                                pnlTourMiscellaneousFields.Visible = true;
                                txtTourMiscDate.Text = finalDate;
                                txtTourMiscAmount.Text = amount;
                                ...
                                break;
                            case "Lodging":
                                pnlTourOthersFields.Visible = true; // Based on ddlTourExpenseType_SelectedIndexChanged
                                txtTourOthersDate.Text = finalDate;
                            ...
                            case "Conveyance":
                                ...
                                if (!string.IsNullOrEmpty(transportMode))
                                {
                                    try { ddlTourTransportMode.SelectedValue = transportMode; } catch { }
                                    ddlTourTransportMode_SelectedIndexChanged(null, null);

                                    switch (ddlTourTransportMode.SelectedValue)
                                    {
                                        case "Flight":
                                            txtFlightDate.Text = finalDate;
                                            txtFlightAmount.Text = amount;
                                        ...
                                        case "Cab":
                                            ...
                                            break;
                                        case "Auto":
                                            txtTourAutoDate.Text = finalDate;
                            ...
                            default:
                                ...
                                txtTourMiscDate.Text = finalDate;
                                txtTourMiscAmount.Text = amount;
                                txtTourMiscItem.Text = subCategory; // Put category name in Item
                                txtTourMiscParticulars.Text = particulars;
                                txtTourMiscRemarks.Text = remarks;
                                txtTourMiscSmoNo.Text = smoNo;
                                txtTourMiscSoNo.Text = soNo;
                    ...
                    // Store the current row index in session for reference
            ...
            {
                lblError.Text = $"Error editing row: {ex.Message}";
                lblError.ForeColor = System.Drawing.Color.Red;
            }
        }
        ...
        private Dictionary<string, List<int>> ExtractColumnHeaders(OfficeOpenXml.ExcelWorksheet worksheet, int headerRowIndex, int colCount)
        {
            ...
            for (int col = 1; col <= colCount; col++)
            {
                ...
                if (!string.IsNullOrEmpty(cleanHeader))
                {
                    ...
                    if (cleanHeader.Contains("misc") || originalLower.Contains("misc") || cleanHeader.Contains("sundry") || originalLower.Contains("sundry") || cleanHeader.Contains("general") || originalLower.Contains("general"))
                        AddToMap("Miscellaneous", col);

                    if (cleanHeader.Contains("other") || originalLower.Contains("other"))
                        AddToMap("Others", col);
